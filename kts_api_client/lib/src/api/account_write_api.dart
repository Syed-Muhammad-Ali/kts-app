...
class AccountWriteApi {

  final Dio _dio;

  final Serializers _serializers;

  const AccountWriteApi(this._dio, this._serializers);
  ...
  Future<Response<bool>> accountWriteCancelAppointment({ 
    ...
    final _path = r'/api/AccountWrite/appointments/cancel';
  ...
  /// Returns a [Future] containing a [Response] with a [bool] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<bool>> accountWriteChangePassword({ 
    ...
    final _path = r'/api/AccountWrite/change-password';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CreateAppointmentResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<CreateAppointmentResponse>> accountWriteCreateAppointment({ 
    ...
    final _path = r'/api/AccountWrite/appointment';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _responseType = FullType(CreateAppointmentResponse);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CreateCusotmerResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<CreateCusotmerResponse>> accountWriteCreateCustomer({ 
    ...
    final _path = r'/api/AccountWrite/customers';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _responseType = FullType(CreateCusotmerResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as CreateCusotmerResponse;
    ...
    return Response<CreateCusotmerResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CreateExpenseResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<CreateExpenseResponse>> accountWriteCreateExpense({ 
    ...
    final _path = r'/api/AccountWrite/expense';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _responseType = FullType(CreateExpenseResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<CreateExpenseResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CreateIncomeResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<CreateIncomeResponse>> accountWriteCreateIncome({ 
    required CreateIncomeRequest request,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/AccountWrite/income';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _responseType = FullType(CreateIncomeResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<CreateIncomeResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CreateServiceResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<CreateServiceResponse>> accountWriteCreateService({ 
    ...
    final _path = r'/api/AccountWrite/services';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _responseType = FullType(CreateServiceResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
  ...
  /// Returns a [Future] containing a [Response] with a [bool] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<bool>> accountWriteDelete({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/AccountWrite/delete';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [bool] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<bool>> accountWriteDeleteCustomer({ 
    required DeleteCustomerRequest request,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [bool] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<bool>> accountWriteDeleteExpense({ 
    required DeleteExpenseRequest request,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(DeleteExpenseRequest);
      _bodyData = _serializers.serialize(request, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [bool] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<bool>> accountWriteDeleteIncome({ 
    required DeleteIncomeRequest request,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(DeleteIncomeRequest);
      _bodyData = _serializers.serialize(request, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [bool] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<bool>> accountWriteDeleteService({ 
    required DeleteServiceRequest request,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [bool] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<bool>> accountWriteForgotPassword({ 
    ...
    final _path = r'/api/AccountWrite/forgot-password';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [bool] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<bool>> accountWriteSetNotificationRead({ 
    required SetNotificationRequest request,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/AccountWrite/notifications/set-read';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SetNotificationRequest);
      _bodyData = _serializers.serialize(request, specifiedType: _type);
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<SignupResponse>> accountWriteSignup({ 
    ...
    final _path = r'/api/AccountWrite/signup';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _responseType = FullType(SignupResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as SignupResponse;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateAccountResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UpdateAccountResponse>> accountWriteUpdateAccount({ 
    ...
    final _path = r'/api/AccountWrite';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _responseType = FullType(UpdateAccountResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<UpdateAccountResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateAppointmentResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UpdateAppointmentResponse>> accountWriteUpdateAppointment({ 
    required UpdateAppointmentRequest request,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _responseType = FullType(UpdateAppointmentResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<UpdateAppointmentResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateCusotmerResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UpdateCusotmerResponse>> accountWriteUpdateCustomer({ 
    ...
    try {
      const _type = FullType(UpdateCustomerRequest);
      _bodyData = _serializers.serialize(request, specifiedType: _type);
    ...
    try {
      const _responseType = FullType(UpdateCusotmerResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as UpdateCusotmerResponse;
    ...
    return Response<UpdateCusotmerResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateExpenseResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UpdateExpenseResponse>> accountWriteUpdateExpense({ 
    ...
    try {
      const _type = FullType(UpdateExpenseRequest);
      _bodyData = _serializers.serialize(request, specifiedType: _type);
    ...
    try {
      const _responseType = FullType(UpdateExpenseResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<UpdateExpenseResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateIncomeResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UpdateIncomeResponse>> accountWriteUpdateIncome({ 
    required UpdateIncomeRequest request,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateIncomeRequest);
      _bodyData = _serializers.serialize(request, specifiedType: _type);
    ...
    try {
      const _responseType = FullType(UpdateIncomeResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<UpdateIncomeResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateServiceResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UpdateServiceResponse>> accountWriteUpdateService({ 
    ...
    try {
      const _responseType = FullType(UpdateServiceResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<UpdateServiceResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UploadFileResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UploadFileResponse>> accountWriteUploadFile({ 
    ...
    final _path = r'/api/AccountWrite/file';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _responseType = FullType(UploadFileResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
